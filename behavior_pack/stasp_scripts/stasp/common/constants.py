...
IRRADIANT_TITANIUM_IRON_PLATE = "stasp:irradiant_titanium_iron_plate"
IRRADIANT_URANIUM = "stasp:irradiant_uranium"
INTEGRATED_SOLAR_PANEL_PANE = "stasp:integrated_solar_panel_pane"
